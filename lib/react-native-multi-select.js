    ...
    return (
      ...
      >
        <View style={{ flexDirection: "column" }}>
          ...
          <View
            style={{ backgroundColor: "#f7941d", width: "100%", height: 0.5 }}
          />
        </View>
      </TouchableOpacity>
    );
            ...
            >
              ...
              {hideSubmitButton && (
                <TouchableOpacity onPress={this._submitSelection}>
                  {Platform.OS == "android" ? (
                    <Icons name="close" size={20} style={styles.indicator} />
                  ) : (
                    <Icon name="close" size={25} style={styles.indicator} />
                  )}
                </TouchableOpacity>
              )}
              {/* {!hideDropdown && (
                  ...
                  >
                    ...
                    {Platform.OS == "android" ? (
                      <Icons
                        name={"down"}
                        size={16}
                        style={[styles.indicator, { right: 10 }]}
                      />
                    ) : (
                      <Icon
                        name={"chevron-down"}
                        size={25}
                        style={[styles.indicator, { right: 5 }]}
                      />
                    )}
                  </View>
                </TouchableWithoutFeedback>
